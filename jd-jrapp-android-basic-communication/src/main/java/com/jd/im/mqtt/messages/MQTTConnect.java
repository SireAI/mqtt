...
//    out.write(MQTTHelper.LSB(keepAlive));
    ...
    protected byte[] generatePayload() throws MQTTException, IOException {
        ...
        DataOutputStream payload = new DataOutputStream(dos);
...
//      throw new MQTTException("Invalid identifier encoding");
        ...
        encodeUTF8(payload, clientIdentifier);
...
//        throw new MQTTException("Invalid will message encoding");
            // Write Will message
            payload.writeShort(willMessage.getBytes("UTF-8").length);
