...
public class MqttQos {
    ...
    public void operate(byte[] data) {
        ...
        switch (type) {
            ...
            case PUBACK:
                ...
                notifyOperationResult(true, pubAckIdentifier);
                break;
            case PUBREC:
    ...
    private void notifyOperationResult(boolean success, int id) {
        if (qosCallBack != null) {
            qosCallBack.notifyOperationResult(success, id);
        }
    }
    ...
    public interface QosCallBack {
         ...
         * @param id
         */
        void notifyOperationResult(boolean success, int id);
